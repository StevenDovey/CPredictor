...
'*************************************************************************************************************
'
' This module contains the 300 Index radiata pine Growth Model and a radiata pine wood density model.
'
'*************************************************************************************************************
...
' Determine height model - 1 = NSW, 2 = Simple NZ, 3 = Environmental NZ
        ...
        ElseIf (IsEmpty(Cells(3, 6)) Or IsEmpty(Cells(4, 6))) Or _
            (Cells(3, 6) < 30 Or Cells(3, 6) > 48) Then   'Test whether latitude within NZ range
            heightmod = 2
        Else
            heightmod = 3
        End If
