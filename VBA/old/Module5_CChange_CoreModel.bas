...
Dim X(16) As Double, ID As Long, INPX As Long, GCLMAX As Double, X3MAX As Double, X4MAX As Double, _
    X5MAX As Double, X6MAX As Double, HTBGC As Double, GCL As Double, BA As Double, BASP(200) As Double, _
    ...
    BNA As Double, BNB As Double, YESN As Double, HTSP(200) As Double, TVOLSP(200) As Double, _
    SSA As Double, SBA As Double, CRA As Double, PMAI As Double, SX3 As Double, NLIMITED As Long, _
    DIAGN(200) As Double, AGEND As Double, CNRAT As Double, XTRACC(10) As Double, XTR As Double, XTRN As Double, XTRP As Double, _
    XTF As Double, XTFN As Double, XTFP As Double, DMINI As Double, FLOSS As Double, CSHRUB As Double, ICOUNT As Long, _
    RADIA As Double, DENWH(200) As Double, DENINC(200) As Double, _
...
'C   SPECIFIED.
    ...
    Dim TITLE As String, TLAM(12) As Double, A(16, 16) As Double, Y(16) As Double, _
        ZNAP(200) As Double, _
        F128SP(200) As Double, F82SP(200) As Double, SPHSP(200) As Double, WDAGE(200) As Double, NAP As Double, _
...
'C    STANDING STOCKS AS NECESSARY, THEREBY GENERATING THE FLOW MATRIX, F
    ...
    MATEMP = Worksheets("C Change").Cells(41, 3)
    ...
    SoilBray2P = Worksheets("C Change").Cells(38, 3)
...
'C    OR ALTERNATIVELY, SIMULATE Z FROM MODELLED LEAF AREA INDEX.
    ...
    Dim PMIMM(12) As Double, RAD(12) As Double, XIMM(12) As Double, AGESP(200) As Double, PNM(12) As Double, _
        ADJPM(12) As Double, TWT(200) As Double, TWTG(200) As Double, VOLGSP(200) As Double, j As Long, _
...
'C
    XN(7) = X(7) * Nconc(16, T) * 10
    XP(7) = X(7) * Pconc(16, T) * 10
